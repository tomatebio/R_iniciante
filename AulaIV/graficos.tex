...
\pgfdeclareimage[width=8cm]{boxplot}{boxplot}
\pgfuseimage{boxplot}  
\end{frame}
...
\pgfdeclareimage[width=8cm]{histograma}{histograma}
\pgfuseimage{histograma}  
\end{frame}
...
\begin{frame}{Auckland's Maunga Whau Volcano}
  ...
  \begin{center}
    \pgfdeclareimage[width=8cm]{volcano}{volcano}
    \pgfuseimage{volcano}
  \end{center}
